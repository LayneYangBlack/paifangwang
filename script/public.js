...
var uploadImageUrl="http://store.paifangwang.com.cn/storage/fangpai/handle";
var uploadVoiceUrl="http://store.paifangwang.com.cn/storage/fangpai/handle";
...
// var serverUrl = "http://192.168.160.109:10004";
// var serverUrl = "http://192.168.2.14:10004";
// recommendServerUrl = "http://192.168.1.25:50050";
var serverUrl = "http://120.77.181.109:20001";
// serverUrl = "http://192.168.240.85:10004";
//========游客身份======
...
var serviceLoadUrl = serverUrl + "/service/load";//服务详情load
var serviceAttestUrl = serverUrl + "/serviceRequest/submitAttest";//服务申请
var serviceSubmitUrl = serverUrl + "/serviceRequest/submitPay";//服务提交支付
var serviceAliPay = serverUrl + "/serviceRequest/alipayParam";//服务支付宝支付
var serviceWxPay = serverUrl + "/serviceRequest/wxpayParam";//服务微信支付
var serviceLoad = serverUrl + "/serviceRequest/load";//服务支付页load
//========服务======
var serviceType = serverUrl+"/serviceType/list";
var announcementUrl = serverUrl+"/announcement/list";//公告
var advertUrl =serverUrl+"/advert/list";//广告
var serviceList = serverUrl+"/service/pager"
//========法拍房系列======
...
var unitHousePagerUrl = serverUrl +"/lawAuctionHouse/unitHousePager";
//========一口价系列======
...
var onePriceBidUrl = serverUrl + "/bitePriceHouse/bid"; //
var onePriceBidPagerUrl = serverUrl + "/bitePriceHouse/bidPager"; //投资房出价列表
//==========关注=========
...
var cancelEnsureGoldUrl = serverUrl + "/ensureGold/cancel"; // 取消保证金
//=================我的页面=================
...
var allServiceUrl = serverUrl+"/user/serviceRequestPager";//提交过的服务申请
var myServiceUrl = serverUrl+"/user/servicePager";//已拥有的服务
var cancelPayUrl = serverUrl + "/serviceRequest/cancel";//取消待支付的服务 srid
//========名企房系列======
...
//========名企房楼盘详情E选房======
var allEhouseUrl =serverUrl+"/enterpriseHousesActivity/all"; //全部列表 ehid
var houseSourceUrl = serverUrl+"/enterpriseHousesActivity/houseSource";//房源 ehid
var carSpaceUrl =serverUrl+"/enterpriseHousesActivity/carSpace";//车位 ehid
var shopUrl =serverUrl+"/enterpriseHousesActivity/shop";//店铺 ehid
var storeroomUrl =serverUrl+"/enterpriseHousesActivity/storeroom";//储存室 ehid
var eHouseDetailUrl =serverUrl+"/enterpriseHousesActivity/houseActivityStructure";//活动结构 ehaid
var eHousesActivityUrl = serverUrl + "/enterpriseHousesActivity/all";//获取所有活动 传ehid
var eHousesSourceUrl = serverUrl + "/enterpriseHousesActivity/houseSource"//所有活动下 房源的活动 传ehid
var eHousesCarSpaceUrl = serverUrl + "/enterpriseHousesActivity/carSpace"//所有活动下 停车的活动 传ehid
var eHousesShopUrl = serverUrl + "/enterpriseHousesActivity/shop"//所有活动下 商铺的活动 传ehid
var eHousesStoreroomUrl = serverUrl + "/enterpriseHousesActivity/storeroom"//所有活动下 储存室的活动 传ehid
var eHuosesListDetailUrl = serverUrl + "/enterpriseHousesActivity/houseActivityStructure";//所有栋列表 传ehaid
//========法拍开始结束提醒======
...
//========名企开始结束提醒======
//E选房提醒
var enterpriseESelectHouseStartUrl =serverUrl+"/enterpriseESelectHouse/startAlarm";
var enterpriseESelectHouseCancelStartUrl = serverUrl+"/enterpriseESelectHouse/cancelStartAlarm";
var enterpriseESelectHouseEndUrl = serverUrl+"/enterpriseESelectHouse/endAlarm";
var enterpriseESelectHouseCancelEndUrl = serverUrl+"/enterpriseESelectHouse/cancelEndAlarm";
//专场提醒
var enterpriseAuctionHouseStartAlarmUrl =serverUrl+"/enterpriseAuctionHouse/startAlarm";
var enterpriseAuctionHouseCancelStartAlarmUrl = serverUrl+"/enterpriseAuctionHouse/cancelStartAlarm";
var enterpriseAuctionHouseEndAlarmUrl = serverUrl+"/enterpriseAuctionHouse/endAlarm";
var enterpriseAuctionHouseCancelEndAlarmUrl = serverUrl+"/enterpriseAuctionHouse/cancelEndAlarm";
//========直播名企开始结束提醒======
...
//直播法拍评论
var liveVideoLawAuctionHouseCommentUrl = serverUrl+"/liveVideoLawAuctionHouse/comment";
var liveVideoLawAuctionHouseCommentPager = serverUrl+"/liveVideoLawAuctionHouse/commentPager";
var liveVideoLawAuctionHouseReplyUrl = serverUrl+"/liveVideoLawAuctionHouse/reply";
//投资评论
var investmentHouseCommentUrl = serverUrl+"/investmentHouse/comment";
var investmentHouseCommentPager = serverUrl+"/investmentHouse/commentPager";
var investmentHouseReplyUrl = serverUrl+"/investmentHouse/reply";
//直播投资评论
var liveVideoInvestmentHouseCommentUrl = serverUrl+"/liveVideoInvestmentHouse/comment";
var liveVideoInvestmentHouseCommentPager = serverUrl+"/liveVideoInvestmentHouse/commentPager";
var liveVideoInvestmentHouseReplyUrl = serverUrl+"/liveVideoInvestmentHouse/reply";
//e选房评论
var enterpriseESelectHouseCommentUrl = serverUrl+"/enterpriseESelectHouse/comment";//评论
var enterpriseESelectHouseCommentPagerUrl = serverUrl+"/enterpriseESelectHouse/commentPager";//分页
var enterpriseESelectHouseReplyUrl = serverUrl+"/enterpriseESelectHouse/reply"; //回复
//专场评论
var enterpriseAuctionHouseHouseCommentUrl = serverUrl+"/enterpriseAuctionHouse/comment";//评论
var enterpriseAuctionHouseHouseCommentPagerUrl = serverUrl+"/enterpriseAuctionHouse/commentPager";//分页
var enterpriseAuctionHouseHouseReplyUrl = serverUrl+"/enterpriseAuctionHouse/reply"; //回复
//直播e选房评论
var liveVideoEnterpriseHouseCommentUrl = serverUrl+"/liveVideoEnterpriseHouse/comment";
var liveVideoEnterpriseHouseCommentPager = serverUrl+"/liveVideoEnterpriseHouse/commentPager";
var liveVideoEnterpriseHouseReplyUrl = serverUrl+"/liveVideoEnterpriseHouse/reply";
//一口价评论
var bitePriceHouseCommentUrl = serverUrl+"/bitePriceHouse/comment";
var bitePriceHouseCommentPager = serverUrl+"/bitePriceHouse/commentPager";
var bitePriceHouseReplyUrl = serverUrl+"/bitePriceHouse/reply";
//楼盘评论
var enterprisesCommertUrl = serverUrl +"/enterpriseHouses/comment ";
var enterprisesCommentPager = serverUrl +"/enterpriseHouses/commentPager ";
var enterprisesReplyUrl = serverUrl +"/enterpriseHouses/reply";
//========登录的url开始======
...
var SpeciaItemsUrl = serverUrl + "/enterpriseSpecialField/auctionHousePager";// 专场下的拍品
var allAuctionItemsUrl = serverUrl + "/enterprise/auctionHousePager"; //所有拍品
var enterpriseAuctionHouseLoadUrl = serverUrl + "/enterpriseAuctionHouse/load" ;// 专场详情页
var enterpriseESelectHouseLoadUrl = serverUrl + "/enterpriseESelectHouse/load" ;// E选房详情页
var enterpriseAuctionHouseSubmitGoldUrl = serverUrl +"/enterpriseAuctionHouse/submitEnsureGold";//专场提交保证金申请
var enterpriseESelectHouseSubmitGoldUrl = serverUrl +"/enterpriseESelectHouse/submitEnsureGold";//e选房提交保证金申请
var enterpriseHouseEnsureGoldLoadUrl = serverUrl + "/ensureGold/load";//名企保证金load
var enterpriseAuctionHouseBidUrl = serverUrl + "/enterpriseAuctionHouse/bid"; //专场竞拍
var enterpriseESelectHouseBidUrl = serverUrl + "/enterpriseESelectHouse/bid"; //E选房竞拍
var enterpriseAuctionHouseBidPagerUrl = serverUrl + "/enterpriseAuctionHouse/bidPager"; //专场竞拍分页
var enterpriseESelectHouseBidPagerUrl = serverUrl + "/enterpriseESelectHouse/bidPager"; //e选房竞拍分页
...
//========================聊天=========================================
//=========IM通知的url开始==============
var chatServerUrl = "http://120.77.181.109:20005";
//========================加入聊天组=========================================
...
function openActiveDetail(id){
	openNewWindow('activeDetail','./activeDetail.html',{ehaid:id})
}
//========系统级别的公共方法（开始）==========
/**
 *
...
// function openChat2(type,thirdId,thirdNick){
